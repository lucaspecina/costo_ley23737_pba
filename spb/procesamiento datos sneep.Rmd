...
Filtro: Todos los delitos provinciales y de PBA (les saco los federales y dejo solo PBA)
...
Filtro: Delitos ley 23737 de PBA
...
unidades <- unidades %>% mutate(prop_droga = cantidad_droga / cantidad_total * 100)
