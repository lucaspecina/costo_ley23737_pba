...
ggplot(data_plot_pctch, aes(x=anio_censo,y=Porcentaje, color=Tipo)) + geom_line() + geom_point() +
    labs(title="Cambio porcentual acumulado de presxs según sean por ley 23737 o total",x="Año de censo", y = "Cambio porcentual acumulado (%)") + facet_wrap(vars(provincia_descripcion), ncol=2)
